...
<section>
        <div class="flex justify-center font-bold text-2xl pt-8 text-black mt-10">
            HELLO THERE !!
        </div>

        <div class="w-full flex justify-center mt-16">
            <form action="admin.login.php" method = "post" onsubmit = "return(validate())">
                <div class="bg-gray-100 format p-10">
                    ...
                    <div class='mt-4'>
                        <a href="admin.register.php" class='font-semibold bg-white border-[1px] border-neutral-800 rounded-xl h-12 flex justify-center items-center text-lg w-full slide-right hover:text-white hover:border-white submit-btn'>
                            REGISTER
                        </a>
                    </div>
                </div>
