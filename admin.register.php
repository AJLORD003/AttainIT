...
<body>
    <section>
        ...
        <div class="w-full flex justify-center mt-12">
            <form action="admin.register.php" method="post" onsubmit="return(validate())">
                <div class="bg-gray-100 format p-10">
                    ...
                    <div class='mt-4'>
                        <a href="admin.login.php" class='font-semibold bg-white border-[1px] border-neutral-800 rounded-xl h-12 flex justify-center items-center text-lg w-full slide-right hover:text-white hover:border-white submit-btn'>
                            LOGIN
                        </a>
                    </div>
                </div>
