...
<a href='main.php' class='text-xs underline font-semibold absolute ml-4 mt-[4rem] text-[#CCCDDE]'>
    ...
    <form action="import.course.co_decription.table.php" method="post">
        <label for="totalco" class="text-[#CCCDDE]">Enter total number of CO:</label>
        <input type="number" id="totalco" name="totalco" placeholder="(min = 1 & max = 10)" required class="text-black border border-neutral-800 text-gray-700 px-4 pr-8 rounded leading-tight focus:outline-none focus:border-indigo-500 focus:shadow-outline-indigo h-[2.4rem] mt-[1rem] ml-[1rem]">
