...
<html lang="en" dir="ltr">
  ...
  <div class="flex justify-center font-bold text-2xl pt-16 text-[#CCCDDE]">
    ...
    <div class="flex justify-center mt-2 text-sm text-[#CCCDDE] opacity-60">
        Your file should have all marks data of students
    </div>
    <div class="w-full justify-center flex">
        <form method="post" enctype="multipart/form-data" class="mt-10" action="import.file.marks.submit.php">
            <div class="flex justify-between w-full">
                ...
                <div class="cont text-[#CCCDDE] flex justify-center w-1/2 hidden items-center underline ml-10"></div>
            </div>
