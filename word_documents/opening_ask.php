...
<div class="flex justify-center w-full mt-10 details-container">
  <form name = "coursedetails" action = "opening_form.php" method = "post" onsubmit = "return(validate())" class="w-[35rem] flex flex-col">
      <div class="format p-10 bg-gray-100">    
      <div class="grid grid-cols-2 gap-12 mt-3">            
            <div>
              <label class="block text-gray-400" for="NumberOfTopicstobeintroduced">Number of topics to be introduced:</label>
              <input type="number" id="NumberOfTopicstobeintroduced" name="NumberOfTopicstobeintroduced" placeholder="Enter number of Topics" class="border border-gray-200 mt-2 outline-blue-500 pl-2 text-gray-500 rounded-md h-8" required>
              </div>                  
      
            <div>
              <label class="block text-gray-400" for="NumberOfDetailsofModification"> Number of details of Modification:</label>
              <input type="number" id="NumberOfDetailsofModification" name="NumberOfDetailsofModification" placeholder="Enter number of details" class="border border-gray-200 mt-2 outline-blue-500 pl-2 text-gray-500 rounded-md h-8" required>
              </div>                   
  ...
  <div>
              ...
              <div>
              <label for="AcademicYear" class="block text-gray-400">Academic Year: </label>
  ...
  <div class="grid grid-cols-2 gap-12 mt-3">
    <div>
    <label for="Semester" class="block text-gray-400">Semester: </label>
  ...
  <div class="flex mt-8 justify-center mb-4">
      <button
        class="font-semibold bg-white border-[1px] border-neutral-800 rounded-xl h-12 flex justify-center items-center text-lg w-60"           
