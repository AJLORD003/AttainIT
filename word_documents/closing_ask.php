...
<body>
    ...
    ?>
        ...
        <div class="flex justify-center w-full mt-10 details-container">
            <form name="coursedetails" action="closing_form.php" method="post" onsubmit="return(validate())" class="w-[35rem] flex flex-col">
                <div class="format p-10 bg-gray-100">
                <div class="grid grid-cols-2 gap-12 mt-3">
                    <div>
                        <label class="block text-gray-400" for="NumberOfSuggestions">Number of Suggestions:</label>
                        <input type="number" id="NumberOfSuggestions" name="NumberOfSuggestions" placeholder="Enter number of Suggestions" class="border border-gray-200 mt-2 outline-blue-500 pl-2 text-gray-500 rounded-md h-8" required>
                    </div>
                ...
                <div>
                <label class="block text-gray-400 mt-3" for="NBACode">NBA Code:</label>
                ...
                <select name="Semester" id="Semester" class="bg-white border border-gray-200 mt-2 text-gray-700 pl-2 rounded-md focus:outline-none focus:border-indigo-500 focus:shadow-outline-indigo">
            ...
            <button class="font-semibold bg-white border-[1px] border-neutral-800 rounded-xl h-12 flex justify-center items-center text-lg w-52" type="submit" name="submit" value="Next" id="new-toast">Next</button>
        </div>
            </form>
        </div>
